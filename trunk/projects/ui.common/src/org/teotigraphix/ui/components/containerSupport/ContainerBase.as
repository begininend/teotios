...
/**
 * The ContainerBase class hosts most containers in toolkits or widgets.
 * 
 * <p>This class adds border and background styles so they are available
 * in MXML.</p>
 * 
 ...
 * @productversion 1.0
 * 
 * @skinstate normal The normal container state.
 * @skinstate disabled The disabled container state.
 * @skinpart contentGroup Group true The Group that the container's visual elements
 * get placed.
 * 
 * @mxml
 */
public class ContainerBase extends SkinnableContainer
{
	 ...
	 * @private
	 */
	protected function get skinLayout():LayoutBase
	{
		if (skin && "layout" in skin)
			return Object(skin).layout;
